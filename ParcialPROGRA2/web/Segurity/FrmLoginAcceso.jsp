    ...
    <center>
        <form name="form" autocomplete="off">
            <table style="width: 400px;height: 100px ;background-color: yellow">
                <tr>
                    <td>Usuario :</td>
                    <td><input type="text"  name="txtUsuario"  autocomplete="off"  /></td>
                </tr>  
                <tr>
                    <td>Clave :</td>
                    <td><input type="password"  name="txtClave"   autocomplete="off" /></td>
                </tr> 
                <tr >
                    <td  colspan="2">
                          <center>
                              <input type="button" name="bntentrar" value="Entrar"  onclick="entrar()"/>
                          </center>                     
                    </td>
                </tr>
            </table>
